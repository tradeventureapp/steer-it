...
//   4. Drop below ~30% of max speed → a warning (HUD blinks); if you don't speed
...
export const XP_CONFIG = {
  ...
  slowSpeedFrac: 0.30,      // below this fraction of maxSpeed → warning starts
...
export interface XpRunState {
  ...
  started: boolean;    // has exceeded the slow threshold at least once (launch grace)
...
export function updateXpRun(
  ...
  // SLOW-SPEED warning + end. Only armed once the car has first got going, so a
  // standing launch (speed 0) never instantly trips it.
